...
begin
 try
  ...
  Tabla.SQL.Clear;
   ...
   Tabla.ExecSQL;
  Mensaje('Se actualizó el estado del comprobante', 'Actualizar estado',3);
 except
   on E : Exception do
...
begin
 ...
 if tabla.RecordCount > 0  then
  ...
  Mensaje('No se ha encontrado comprobante definido del tipo '+ IdTipoComp +' para el punto de venta '+PtoVta ,'Numeración de comprobantes',3);
 Tabla.close;
 Tabla.Destroy;
end;
