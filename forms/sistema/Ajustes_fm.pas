...
//Conexi�n
 ...
 // Impresion fiscal
   ...
   AjusteObj.SoftFactElectPath := Ed_ProgFactElect.text;
   AjusteObj.SoftPadronAfip := Ed_ProgPadronAfip.text;
...
//Conexi�n
 ...
 // Impresion fiscal
   ...
   Ed_ProgFactElect.text := AjusteObj.SoftFactElectPath;
   Ed_ProgPadronAfip.text := AjusteObj.SoftPadronAfip;
...
begin
 OD_Config.Filter := 'Im�gen|*.jpg;*.bmp;*.png';
