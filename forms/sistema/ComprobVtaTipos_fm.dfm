object FmConfTiposComprob: TFmConfTiposComprob
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Tipos de Comprobantes de venta'
  ClientHeight = 348
  ClientWidth = 774
  Color = clBtnFace
  ...
  object Pn_EditAdd: TPanel
    ...
    object Ed_ComprobVtaDescrip: TEdit
      Left = 108
      Top = 23
      Width = 231
      Height = 21
    ...
    object Cb_ComprobVtaTipoDebCred: TComboBox
      Left = 10
      Top = 67
      Width = 88
      Height = 23
    ...
    object CB_ComprobVtaStock: TComboBox
      Left = 104
      Top = 67
      Width = 90
      Height = 23
    ...
    object Cb_ComprobVtaIVA: TComboBox
      Left = 200
      Top = 67
      Width = 74
      Height = 23
    ...
    object Ed_ComprobVtaCodAfip: TEdit
      Left = 66
      Top = 111
      Width = 72
      Height = 21
    ...
    object Ed_ComprobVtaLetra: TEdit
      Left = 10
      Top = 111
      Width = 50
      Height = 21
