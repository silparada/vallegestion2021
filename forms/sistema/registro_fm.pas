...
var
  ...
  ca1: string;
begin
{ if not (E6.text =  StrCheckSum('Valle Gestión - Versión Libre'+E1.TEXT+E2.TEXT)) then
    begin
     Mensaje('El código de Activación no es válido','Activación',3);
     exit;
    end;   }
...
//  Reg.WriteBool('codeact',true) ;
  ...
  Mensaje('El sistema se ha activado exitosamente !!. Reinicie para visualizar los cambios.','Activación',3);
//  Reg.free;
end;
