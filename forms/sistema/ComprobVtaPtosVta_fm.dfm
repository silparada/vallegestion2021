object FmConfPuntosVta: TFmConfPuntosVta
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object Pn_EditAdd: TPanel
    ...
    object CB_PtoVtaTipoFac: TComboBox
      Left = 9
      Top = 63
      Width = 160
      Height = 23
