...
begin
   ...
   if Cliente.UltimaVta > 0 then
     lb_UltimaVta.caption := 'Última vta.: '+ FormatDateTime('dd/mm/yyyy' , Cliente.UltimaVta) else lb_UltimaVta.caption := 'Última vta.:' ;
   if Cliente.UltimaPago > 0 then
    lb_UltimoPago.caption := 'Última vta.: '+ FormatDateTime('dd/mm/yyyy' , Cliente.UltimaPago) else lb_UltimoPago.caption := 'Última vta.:' ;
   ...
   if Cliente.UltimaAct > 0 then
    lb_UltAct.caption := 'Última act.: '+ FormatDateTime('dd/mm/yyyy' , Cliente.UltimaAct) else lb_UltAct.caption := 'Última act.:' ;
   if Cliente.FechaAlta > 0 then
    lb_FechaAlta.caption := 'Última alta: '+ FormatDateTime('dd/mm/yyyy' ,Cliente.FechaAlta) else lb_FechaAlta.caption := 'Fecha alta:' ;
   Me_Observaciones.clear;
