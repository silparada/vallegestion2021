object FmArchivos: TFmArchivos
  ...
  object ADODataSet1: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'SELECT Ciudades.*, Clientes.*  FROM Clientes INNER JOIN Ciudades' +
      ' ON Clientes.CodPostal=Ciudades.CodPostal ORDER BY Clientes.Nomb' +
      're'
    Parameters = <>
    Left = 768
    Top = 336
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43566.434503263890000000
